...
cp native/build-x64/src/Release/Project\ PK.exe build/win-x64/
cp build/libs/Project-PK.jar build/win-x64/
...
echo Project\ PK.exe 64bit sha256sum
sha256sum build/win-x64/Project\ PK.exe

dumpbin //HEADERS build/win-x64/Project\ PK.exe
