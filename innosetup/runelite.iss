...
DefaultDirName={localappdata}\Project_PK
...
OutputBaseFilename=ProjectPKSetup
...
[Icons]
; start menu
Name: "{userprograms}\Project_PK\Project PK"; Filename: "{app}\Project PK.exe"
Name: "{userprograms}\Project_PK\Project PK (configure)"; Filename: "{app}\Project PK.exe"; Parameters: "--configure"
Name: "{userprograms}\Project_PK\Project PK (safe mode)"; Filename: "{app}\Project PK.exe"; Parameters: "--safe-mode"
Name: "{userdesktop}\Project_PK"; Filename: "{app}\Project PK.exe"; Tasks: DesktopIcon
...
; previous shortcut
Type: files; Name: "{userprograms}\Project_PK.lnk"
