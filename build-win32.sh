...
cp native/build-x86/src/Release/Project PK.exe build/win-x86/
cp build/libs/Project PK.jar build/win-x86/
...
echo Project PK.exe 32bit sha256sum
sha256sum build/win-x86/Project PK.exe

dumpbin //HEADERS build/win-x86/Project PK.exe
